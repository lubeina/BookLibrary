...
A small Book Library app for managing books and authors. Built with a .NET Web API backend and a Blazor Server frontend, connected to a PostgreSQL database.
